...
# Test 3: Command with JSON extra_params
print("\nTest 3: Command with JSON extra_params")
func, params = parse_command_line("gotarget id=Station1 extra_params={'x':1.0,'y':2.0}")
print(f"  Result: {func}({params})")
...
# Test 5: Disable JSON support
print("\nTest 5: Disable JSON support")
func, params = parse_command_line("reloc x=0.0 y=0.0", support_json_params=False)
print(f"  Result: {func}({params})")
assert func == "reloc"
assert params == {'x': 0.0, 'y': 0.0}
print("  ✅ Passed")
